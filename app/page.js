        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuresData.map((feature, index) => (
              <Card className="p-6 bg-white shadow-lg" key={index}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonialsData.map((testimonial, index) => (
              <Card key={index} className="p-6 bg-white shadow">
      ...
      <section className="py-20 bg-gradient-to-r from-green-700 to-blue-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8 max-w-2xl mx-auto">
            ...
            smarter with Finova. Sign up today and start your free trial!
          </p>
          <Link href="/dashboard">
            <Button
              size="lg"
              className="bg-white text-green-800 hover:bg-gray-200 animate-bounce"
            >
              Start Free Trial
            </Button>
          </Link>
